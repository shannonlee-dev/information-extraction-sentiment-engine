...
@pytest.mark.parametrize('case', [c for c in CASES if c['variant'] != 'challenge-unsupported'],
...
@pytest.mark.parametrize('text', [
    'user..name@example.com', 'user@localhost', 'user@example.com..invalid',
    '010-12-5678', '010-1234 5678', '9010123456789',
    '2023-02-29', '2024/13/01', '2024-02-29-30',
    '1,00원', '2만 1억원', '$10.50', 'https:///path',
])
...
def test_all_five_types_and_normalized_values():
    ...
    assert [item['type'] for item in items] == ['email', 'phone', 'date', 'money', 'url']
    assert [item['normalized'] for item in items] == [
        'User@example.com', '010-1234-5678', '2024-01-15',
        {'amount': 120000000, 'currency': 'KRW'}, 'http://example.com/a?q=1',
    ]
