...
정리 과정에서 삭제한 과거 계획서의 예문 중 자동 수집에서 빠지는 문장도 이 파일에
보존했습니다. exposure-register.jsonl의 과거 문서 경로와 줄 번호는 수집 당시 기록이며,
해당 원문은 Git 커밋 `db765d9`에서 확인할 수 있습니다. v1의 동결 노출 목록은 유지합니다.
