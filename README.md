...
현재 감성 엔진은 KOMORAN·감사된 사전·국소 문법으로 재구성했으며, 새로운 독립 최종 성능은 아직 측정하지 않았다.
...
원본은 297개 항목이며 감사·충돌 제외·활용형 병합 후 compiled 대표 어휘는 **262개**다.
그중 긍정 128개·부정 134개, 직접 구축한 `customer_support` 어휘는 **58개**다.
